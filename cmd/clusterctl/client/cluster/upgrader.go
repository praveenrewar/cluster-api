...
type ProviderUpgrader interface {
	...
	ApplyPlan(opts InstallOptions, clusterAPIVersion string) error

	// ApplyCustomPlan plan executes an upgrade using the UpgradeItems provided by the user.
	ApplyCustomPlan(opts InstallOptions, providersToUpgrade ...UpgradeItem) error
}
...
func (u *providerUpgrader) ApplyPlan(opts InstallOptions, contract string) error {
...
func (u *providerUpgrader) ApplyCustomPlan(opts InstallOptions, upgradeItems ...UpgradeItem) error {
	log := logf.Log
	log.Info("Performing upgrade...")
...
func (u *providerUpgrader) doUpgrade(upgradePlan *UpgradePlan, opts InstallOptions) error {
	...
	return waitForProvidersReady(opts, installQueue, u.proxy)
}
